...
1. Clone este repositório:
  ```bash
https://github.com/Fernandoxiru/APPSPORT/
...
│   │   │   │   ├── corrida.jpg                        # Imagem de exemplo para o esporte
...
## **Tela Principal**
![image](https://github.com/Fernandoxiru/APPSPORT/blob/master/assets/telaprincipal.png))
...
**Fernandoxiru** - Desenvolvedor - [GitHub](https://github.com/Fernandoxiru)
  ...
  ## 📄 Licença
  Este projeto está licenciado sob os termos da licença MIT.detalhes, veja o arquivo [LICENSE](https://github.com/Fernandoxiru/APPSPORT/blob/master/LICENSE)). 
